...
U8X8_SSD1306_128X32_UNIVISION_SW_I2C  u8x8(/* clock=*/ D2, /* data=*/ D1, /* reset=*/ U8X8_PIN_NONE);   // OLEDs without Reset of the Display
...
const char* SSID = "Dom"; //"WLAN1-ABD13";
// Change the part in brackets to your WiFi password
const char* PASSWORD = "07251498"; //"dDRaE57e7MnAbje";
// Change the part in brackets to your Duino-Coin username
const char* USERNAME = "revox"; // badyl
// Change the part in brackets if you want to set a custom miner name (use Auto to autogenerate, None for no name)
const char* RIG_IDENTIFIER = "revoxhere.github.io";
// Change the part in brackets to your mining key (if you enabled it in the wallet)
const char* MINER_KEY = "1337";
...
void loop() {
  ...
  for (unsigned int duco_numeric_result = 0; duco_numeric_result < difficulty; duco_numeric_result++) {
    ...
    if (result == expected_hash) {
      ...
      hashrate = (duco_numeric_result / elapsed_time_s) + 1000;
      share_count++;
